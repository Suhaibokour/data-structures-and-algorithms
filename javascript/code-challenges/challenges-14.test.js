...
* the name must contain only letter items (white spaces are ok)

------------------------------------------------------------------------------------------------ */

const screenForNames = (arr) => {
  // Solution code here...
  let array = /^(Mr\.|Mrs\.|Ms\.|Dr\.).\w*$/;
  return arr.filter(index => index.match(array));
}

/* ------------------------------------------------------------------------------------------------
CHALLENGE 2

Write a function named toTitleCase that takes in an array of strings and returns an array of strings with the first item in upper case and the rest as is.
...
Write a function named biggerThanLuke that, given the Star Wars data, below, returns the names of the items whose mass is greater than Luke's.

The names should be combined into a single string with each item name separated by a dash.
...
const sortBy = (property, arr) => {
  // Solution code here...
  return arr.sort((fst, sec) => {
    return fst[property] > sec[property] ? 1 : -1;
  });
};
...
describe('Testing challenge 3', () => {
  test('It should return only items that are bigger than Luke', () => {
